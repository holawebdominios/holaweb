      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-8 text-center relative z-10">
        ...
        >
          <h2 className={cn([
            ...
            "text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-6"
          ])}>
          ...
          <p className="text-sm sm:text-base lg:text-lg text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            No pierdas más tiempo. Verificá disponibilidad, adquirí tu dominio y empezá a construir tu presencia online hoy mismo.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <motion.button
              ...
              className="px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-xl transition-all duration-300 min-w-[200px] flex items-center justify-center group hover:bg-white"
              style={{ 
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-8 text-white/90">
